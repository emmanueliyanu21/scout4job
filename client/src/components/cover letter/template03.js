...
record of...." rows="3"></textarea>
                            ...
                            <div className="col-md-6 sidebar-fixed">
                                ...
                                <div className="form-img cover-letter template-3">
                                    ...
                                    <div className="phone-Email-section pt-3 row">
                                    ...
                                    <div className="cover-body pt-5 row">
                                        <div className="col-md-3">
                                            <div className="">
                                                <h2>{this.state.managerName}</h2>
                                                <p>{this.state.companyName}</p>
                                            </div>
                                            <div className="From" id="From-letter" style={{display: "none"}} >
                                                <h2>{this.state.fullName}</h2>
                                                <p>{this.state.jobTitle}</p>
                                            </div>
                                        </div>
...
export default connect(null, mapDispatchToProps)(TemplateNO3)
